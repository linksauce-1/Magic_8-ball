...
details = '  Created by @linksauce_1. Copywrong 2023.\n'
...
# initial loop
while True:
    start = input('Press return to get some wisdom: ')
    print()
    if start == '':
        stno = random.randint(1, 9) 
        if stno == 1:
            print(r1)
            break
        elif stno == 2:
...
# continue loop
while True:
    keepstate = input('Would you like more wisdom?\nEnter \'y\' to continue or \'n\' to exit: ')
    print()
    if keepstate == 'y':
